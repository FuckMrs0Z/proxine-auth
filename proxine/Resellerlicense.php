...
{
	$check_lic1 = mysqli_query($con, 'SELECT * FROM license WHERE PROGRAM=\''.$_SESSION['program'].'\' AND `EXPIRY` != "Not Set"');
    $rowlic = mysqli_fetch_array($check_lic1);
	$additionday = "+".$_POST['CompensateAllDay']." days";
	$additionhour = "+".$_POST['CompensateAllHour']." hours";
...
<body>
	...
	<div class="content-wrapper">
                          ...
                          <div class="modal-body">
                            <form method="post">
                              <div class="form-group">
                                ...
                                <input type="text" placeholder="E.g 1" name="CompensateAllDay"class="form-control" id="recipient-name">
                              </div>
							  <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Hour(s)</label>
                                <input type="text" placeholder="E.g 1" name="CompensateAllHour"class="form-control" id="recipient-name">
                              </div>
                          </div>
                          <div class="modal-footer">
                            <button type="submit" name="CompensateAll"class="btn btn-primary">Create</button>
                            </form>
		...
		<div class="row ">
            ...
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Reseller Licenses</h4>
                <div class="row">
                  <div class="col-12">
                    <div class="table-responsive">
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                        <?php foreach ($res_b as $rows): if ($rows['USER_ID'] == $_SESSION['ID'] && $rows['PROGRAM'] == $_SESSION['program'] && $rows['RESELLER_ID'] != NULL) {?>
                          <tr>
