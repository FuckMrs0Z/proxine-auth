...
if (isset($_POST['CompensateAll1']))
{
	...
	$check_lic2 = mysqli_query($con, 'SELECT * FROM license WHERE ID=\''.$_POST['CompensateAll1'].'\' AND `USER_ID` = \''.$_SESSION['ID'].'\'');
	...
	$time->modify($additionhour);
    $result = $time->format('Y-m-d H:i:s');
	mysqli_query($con, 'UPDATE `license` SET `EXPIRY` = \''.$result.'\' WHERE ID = \''.$_POST['CompensateAll1'].'\'');
...
<body>
	<div class="container-scroller">
		...
		<div class="row ">
            ...
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Banned Licenses</h4>
                <div class="row">
                  <div class="col-12">
                    <div class="table-responsive">
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                        <?php foreach ($res_b as $rows): if ($rows['USER_ID'] == $_SESSION['ID'] && $rows['PROGRAM'] == $_SESSION['program'] && $rows['BANNED'] == "Yes") {?>
                          <tr>
                          <td><?php echo $rows['ID']; ?></td>
                        <td><?php echo $rows['KEY']; ?></td>
                        <td><?php echo $rows['BANNED_REASON']; ?></td>
