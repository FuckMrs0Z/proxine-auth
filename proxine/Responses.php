...
if(isset($_POST["change1"]))
     {
      $randomletter = substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXY1234567890YXWVUTSRQPNOMLKIHGFEDBCA0987654321"), 0, 8);
	  ...
	  $randomletter5 = substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXY1234567890YXWVUTSRQPNOMLKIHGFEDBCA0987654321"), 0, 8);
      $sql = 'UPDATE `programs` SET `RESPONSE_SUCCESS` = "'.$randomletter.'", `RESPONSE_INVALID` = "'.$randomletter1.'", `RESPONSE_HWID` = "'.$randomletter2.'", `RESPONSE_HASH` = "'.$randomletter3.'", `RESPONSE_EXPIRED` = "'.$randomletter4.'", `RESPONSE_BANNED` = "'.$randomletter5.'" WHERE `PROGRAM_NAME` = \''.$_SESSION['program'].'\' AND `PROGRAM_ID`  = \''.$_POST['change1'].'\' AND `PROGRAM_USER` = \''.$_SESSION['username'].'\'';
      $les = mysqli_query($con, $sql);
      echo '<script>window.location.replace("Responses.php");</script>';
        ...
        <div class="row quick-action-toolbar">
              ...
              <form class="form-validate" method="post">
                      <div class="form-group">
                        <b><label>Response Success</label></b>
                        <input name="access" type="text" required data-msg="Please Type Yes To Confirm" readonly style="background-color: #2A3038;" value="<?php echo $row['RESPONSE_SUCCESS']; ?>" class="form-control">
                      </div>
                      <div class="form-group">
                        <b><label>Response Invalid</label></b>
                        <input name="access" type="text" required data-msg="Please Type Yes To Confirm" readonly style="background-color: #2A3038;" value="<?php echo $row['RESPONSE_INVALID']; ?>" class="form-control">
                      </div>
                      <div class="form-group">
                        <b><label>Response Expired</label></b>
                        <input name="access" type="text" required data-msg="Please Type Yes To Confirm" readonly style="background-color: #2A3038;" value="<?php echo $row['RESPONSE_EXPIRED']; ?>" class="form-control">
                      </div>
                      <div class="form-group">
                        <b><label>Response Hash</label></b>
                        <input name="access" type="text" required data-msg="Please Type Yes To Confirm" readonly style="background-color: #2A3038;" value="<?php echo $row['RESPONSE_HASH']; ?>" class="form-control">
                      </div>
                      <div class="form-group">
                        <b><label>Response Hwid</label></b>
                        <input name="access" type="text"required data-msg="Please Type Yes To Confirm" readonly style="background-color: #2A3038;" value="<?php echo $row['RESPONSE_HWID']; ?>" class="form-control">
                      </div>
					  <div class="form-group">
                        <b><label>Response Banned</label></b>
                        <input name="access" type="text"required data-msg="Please Type Yes To Confirm" readonly style="background-color: #2A3038;" value="<?php echo $row['RESPONSE_BANNED']; ?>" class="form-control">
                      </div>
                      <table>
                      <tr>
                      <form method="post">
                        <button id="key" type="submit" name="change1" value="<?php echo $row['PROGRAM_ID']; ?>" class="btn btn-outline-success">Randomize</button>
                      </form>
                      </tr>
                      <tr> </tr>
